...
class ExpertManager(log: ResultLog)
{
    ...
    suspend fun determineLanguage(text: Text, syntaxDatabase: LanguageSyntaxDatabase) : Result {
    ...
    private suspend fun askExperts(text: Text, syntaxDatabase: LanguageSyntaxDatabase){
